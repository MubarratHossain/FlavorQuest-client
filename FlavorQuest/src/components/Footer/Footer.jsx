    ...
    <footer className="footer bg-gradient-to-r from-green-400 via-yellow-400 to-orange-400 text-black p-10 mt-4 rounded-lg">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold">FlavorQuest</h2>
          <p className="text-sm">
            Embark on a journey to explore flavors around the world. Discover, taste, and share your culinary experiences.
          </p>
        </div>
      ...
      <div className="mt-10 border-t border-black/20 pt-5 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="mt-5 md:mt-0 text-sm text-black">
          &copy; {new Date().getFullYear()} FlavorQuest. All rights reserved.
        </div>
      </div>
    </footer>
  );
